...
{
    internal sealed class PlazmaConfiguration : DbMigrationsConfiguration<DataBase.Contexts.PlazmaContext>
    {
        public PlazmaConfiguration()
        {
            AutomaticMigrationsEnabled = false;
            MigrationsDirectory = @"PlazmaMigrations";
        }

        protected override void Seed(DataBase.Contexts.PlazmaContext context)
        {
            ...
            {
                HomePageUrl = "https://www.instagram.com/plasmolifting.by/",
                Login = "plasmolifting.by",
                Password = "8888874",
            };
