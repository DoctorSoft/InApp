...
{
    internal sealed class GadalkaTamaraConfiguration : DbMigrationsConfiguration<DataBase.Contexts.GadalkaTamaraContext>
    {
        public GadalkaTamaraConfiguration()
        {
            AutomaticMigrationsEnabled = false;
            MigrationsDirectory = @"GadalkaTamaraMigrations";
        }

        protected override void Seed(DataBase.Contexts.GadalkaTamaraContext context)
        {
            ...
            {
                HomePageUrl = "https://www.instagram.com/gadalka.tamara.minsk/",
                Login = "gadalka.tamara.minsk",
                Password = "03111981t",
            };
